<tr class="border-b dark:border-gray-700">
    ...
    <td class="px-4 py-3">
        @if($activity)
            <span class="bg-red-500 text-white p-2 rounded-md font-bold">not published</span>
        @else
            <span class="bg-green-500 text-white p-2 rounded-md font-bold">published</span>
        @endif
