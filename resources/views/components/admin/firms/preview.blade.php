...
@if(isset($index))
            {{ $index }}
@else
<span class=" p-2 bg-red-500 rounded-md text-white">noindex</span>
@endif
    ...
    <td class="px-4 py-3 flex items-center justify-end">
        ...
        <div id="elem-{{ $id }}-dropdown" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
            <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="elem-{{ $id }}-dropdown-button">
                <li>
                    <a href="{{ route('admin.firm.show', $id) }}" class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Show</a>
                </li>
                <li>
                    <a href="{{ route('admin.firm.edit', $id) }}" class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Edit</a>
                </li>
                <li>
