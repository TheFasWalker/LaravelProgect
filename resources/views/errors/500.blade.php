...
<section class="bg-white dark:bg-gray-900 h-[100vh] flex items-center justify-center">
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div class="mx-auto max-w-screen-sm text-center">
            ...
            <p class="mb-4 text-lg font-light text-gray-500 dark:text-gray-400">Сайт устал. </p>
            <p class="mb-4 text-lg font-light text-gray-500 dark:text-gray-400">Сайт пошёл спать. </p>
