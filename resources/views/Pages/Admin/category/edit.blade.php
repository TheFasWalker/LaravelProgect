...
<x-admin.general.sidebar/>
    ...
    <main class="p-4 md:ml-64 h-auto pt-20">
      <h1 class="mx-auto text-center text-5xl font-bold pb-10">Редактирование Категории {{ $category->title }}</h1>
